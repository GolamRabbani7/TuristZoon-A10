...
const Navber = () => {
    ...
    const navber = <>
        ...
        <li><NavLink to='/allTuristSoprt' className={({ isActive }) => isActive ? 'text-blue-600 mx-2 font-medium border-2 border-blue-500'
            : '  mx-2'}> All Tourists Spot</NavLink></li>
        <li><NavLink to='/addTuristSoprt' className={({ isActive }) => isActive ? 'text-blue-600 mx-2 font-medium border-2 border-blue-500'
            : '  mx-2'}> Add Tourists Spot</NavLink></li>
        <li><NavLink to='/myList' className={({ isActive }) => isActive ? 'text-blue-600 mx-2 font-medium border-2 border-blue-500'
            : '  mx-2'}> My List</NavLink></li>
        ...
        <div className="">
            <div className="navbar relative bg-sky-400 sticky top-5 shadow-lg rounded-md ">
                <div className="navbar-start">
                    ...
                    <a className=" font-bold p-3  text-indigo-500 
                     text-2xl">TuristZoon</a>
                </div>
